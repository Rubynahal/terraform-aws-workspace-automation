...
variable "attach_workspace_creation_policy" {
  description = "Controls whether workspace creation and termination should be added to IAM role for Lambda Function"
  type        = bool
  default     = true
}

variable "attach_kms_key_policy" {
  description = "Controls whether KMS key policy should be added to IAM role for Lambda Function"
  type        = bool
  default     = true
}
...
variable "source_bucket" {
  description = "source bucket for csv file"
  type        = string
  default     = null
}
...
variable "policy_kms_key_arns" {
  description = "List of KMS key ARNs that will be added to the key policy statement when attach_kms_key_policy = true"
  type        = list(string)
  default     = []
}
